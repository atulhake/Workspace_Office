...
public class Wordpress2 
{
	...
	{
		System.setProperty("webdriver.gecko.driver", "C://Users//mithbavkar_s//Downloads//Sid002_JARS//Browser Jars//geckodriver-v0.19.1-win64//geckodriver.exe");					 
	...
	{	
		EDC config=new EDC("D:\\Learnings\\QuestTCDataSheetAuto.xlsx");
		...
		{
			Udata[i][0]=config.getData(0, i, 0);
			Udata[i][1]=config.getData(0, i, 1);
		}
